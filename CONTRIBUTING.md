...
1. Reporting an issue or making a feature request [here](https://github.com/and-digital-cloud/terraform-aws-nexus/issues).
...
1. Fork and *git clone* [the-repo](https://github.com/and-digital-cloud/terraform-aws-nexus).
2. Create a new *git branch* from the master branch where you develop your changes.
3. Create a [Pull Request](https://github.com/and-digital-cloud/terraform-aws-nexus/pulls) for your contribution by following the instructions in the pull request template.
...
2. **Documentation**: Pull requests need to update the [documentation](https://github.com/and-digital-cloud/terraform-aws-nexus/blob/master/README.md) together with the code change.
